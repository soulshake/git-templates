...
# under the License.
# https://gist.githubusercontent.com/carlos-jenkins/89da9dcf9e0d528ac978311938aade43/raw/868756aa9a4ceb5a5d6ee1626824534ae9e874d5/multihooks.py
...
def main():
    ...
    for h in hooks:
        ...
        log.info("Warning: doesn't work for interactive scripts!")
